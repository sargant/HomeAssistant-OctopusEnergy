...
class OctopusEnergyElectricityCurrentStandingChargeDataLastRetrieved(OctopusEnergyElectricitySensor, OctopusEnergyBaseDataLastRetrieved):
  ...
  def unique_id(self):
    ...
    return f"octopus_energy_electricity_{self._serial_number}_{self._mpan}_standing_charge_data_last_retrieved"
    
  @property
  def name(self):
    """Name of the sensor."""
    return f"Standing Charge Data Last Retrieved Electricity"