...
class OctopusEnergyHeatPumpWeatherCompensationMaximumTemperature(CoordinatorEntity, BaseOctopusEnergyHeatPumpSensor, RestoreSensor):
  """Sensor for displaying the maximum temperature for weather compensation of a heat pump."""
  ...
  def unique_id(self):
    ...
    return f"octopus_energy_heat_pump_{self._heat_pump_id}_weather_compensation_maximum_temperature"
  ...
  async def async_added_to_hass(self):
    ...
    if state is not None and last_sensor_state is not None and self._state is None:
      ...
      _LOGGER.debug(f'Restored OctopusEnergyHeatPumpWeatherCompensationMaximumTemperature state: {self._state}')
