...
!!! info
    ...
    This has changed in v20. Entity IDs are now automatically generated by Home Assistant. Device names now contain the meter serial number and MPAN/MPRN. See [Entity IDs and names](./entity_ids.md) for further details.
